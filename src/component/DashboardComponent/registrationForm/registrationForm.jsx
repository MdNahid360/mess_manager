...
const RegistrationForm = () => {
  ...
  return (
    <div className={` ${theme ? 'bg-large-dark' : 'bg-large-light'} py-[10%]  h-screen flex items-center justify-center`}>
      <div className="md:pt-20 pt-[50%]">
        <div className={`${theme ? 'bg-gray-900 text-gray-300' : 'bg-white ring-1'}  ring-gray-300 md:px-8 px-4 md:pt-0 pt-12 pb-8 mb-4 md:w-[600px] w-[92vw] `}>
          <img src={logo} alt="logo" className="m-auto w-[110px]" />
